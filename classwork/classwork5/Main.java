...
public class Main {
    ...
    public static void main(String[] args) throws IOException, BunnyException {
        ...
        bunny1.training();
        bunny1.sleep(1);
        Bunny bunny4 = Bunny.crossBreading(bunny1, bunny2, "list");
        hungryStatus(bunny4);
        bunny4.feed();
        hungryStatus(bunny4);
        bunny4.training();
        ...
        try{
            ...
            throw new BunnyException("Bunny shouldn't be null.", e);
        }
