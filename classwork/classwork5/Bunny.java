...
//    public void implantDecorate(String decorate) throws BunnyException {
//        try{
...
//            throw new BunnyException("Decorate should be not null.", e);
//        }
//    }

//    public static String implantDecorateNullCheck(String decorate) throws BunnyException {
//        try{
//            int check = decorate.length();
//            return decorate;
//        }catch(NullPointerException e){
//            throw new BunnyException("Decorate should be not null.");
//        }
//    }
//    public static String implantDecorateNullCheck(String decorate, boolean check) throws BunnyException {
//        try{
//            int check2 = decorate.length();
//            return decorate;
//        }catch(NullPointerException e){
//            throw new BunnyException("Bunny should be decorative.");
//        }
//    }
